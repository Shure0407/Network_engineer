...
Выполняем перезагрузку коммутаторов с помощью команды ***erase startup-config***
...
- Какой порт выбран протоколом STP в качестве порта корневого моста на каждом коммутаторе некорневого моста?
 ...
 На S1 выбран порт Fa0/1, на S3 выбран порт Fa0/1

- Почему протокол STP выбрал эти порты в качестве портов корневого моста на этих коммутаторах?

Протокол STP выбрал эти порты в качестве портов корневого моста, выбрав наименьший Port ID: 128.1 
